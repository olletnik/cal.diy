...
export const metadata: Metadata = {
  title: "Terminbuchung referral program - Earn money by sharing your link",
  description:
    "Earn 20% recurring commissions for a full year by referring others to Terminbuchung, while giving your referrals 20% off for 12 months. Share your link and start earning today!",
};
