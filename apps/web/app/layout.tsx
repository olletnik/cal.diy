...
// Kintello: Roboto als Grundschrift (passend zu den Websites der Kunden, z. B. Kinderschutzbund)
const interFont = Roboto({ weight: ["400", "500", "700"], subsets: ["latin"], variable: "--font-sans", preload: true, display: "swap" });
