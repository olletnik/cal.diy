...
export const WEBSITE_URL = ensureProtocol(process.env.NEXT_PUBLIC_WEBSITE_URL) || "https://kintello.de";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Terminbuchung";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "ki@kintello.de";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Kintello GmbH";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "Cal";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "Terminbuchung";
...
export const ROADMAP = "https://kintello.de";
export const DESKTOP_APP_LINK = "https://kintello.de";
export const JOIN_COMMUNITY = "https://github.com/calcom/cal.diy/discussions";
export const POWERED_BY_URL = "https://kintello.de";
export const DOCS_URL = "https://kintello.de";
...
export const WEBSITE_PRIVACY_POLICY_URL =
  process.env.NEXT_PUBLIC_WEBSITE_PRIVACY_POLICY_URL || "https://kintello.de/datenschutz";
export const WEBSITE_TERMS_URL = process.env.NEXT_PUBLIC_WEBSITE_TERMS_URL || "https://kintello.de/impressum";
